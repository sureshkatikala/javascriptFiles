var Cookie = function() {
  ...
  , WidgetDOM = function() {
    ...
    return a.addStyle = function(a) {
        ...
        b.type = "text/css",
        b.textContent = a,
        document.body.insertBefore(b, document.body.getElementsByTagName("*")[0])
    }
    ,
    ...
    a.addDiv = function(a, b, c) {
        ...
        return d.id = a,
        "string" == typeof b || b instanceof String ? d.innerHTML = b.toString() : d.appendChild(b),
        c ? document.body.insertBefore(d, document.body.getElementsByTagName("*")[0]) : document.body.appendChild(d),
        d
    }
    ,
    a.addDivClear = function(b) {
        var c = document.createElement("div");
        return a.setClass(c, "clear"),
        b.appendChild(c),
        b
    }
    ,
  ...
  , WhWidgetSendButton = function() {
    ...
    a.init = function(b, c, d) {
        if (a.checkParams(b, c, d)) {
            ...
            d = WidgetInitializer.checkAndClearProOptions(d, window.location.hostname),
            WidgetDetect.isMobile() && d.hasOwnProperty("mobile") && !1 === d.mobile || !WidgetDetect.isMobile() && d.hasOwnProperty("desktop") && !1 === d.desktop || WidgetInitializer.widgetInitialize("container", e, d)
        }
    }
    ,
    a
...
var WidgetInitializer = function() {
    ...
    a.initParams = function(a) {
        ...
        return b.proto = "https:" === a.proto ? "https:" : "http:",
        b.host = a.host,
        b
    }
    ,
    a.initOptions = function(b, c) {
        var d = b;
        return -1 === a.supportedPosition.indexOf(d.position) && (d.position = a.RIGHT_POSITION),
    ...
    a.checkAndClearProOptions = function(b, c) {
        ...
        return b.domain && d.push(b.domain),
        b.hasOwnProperty("domain") && b.hasOwnProperty("key") && b.domain && b.key && -1 !== a.getAvailableProOptionsDomains(d).indexOf(c.toLowerCase()) ? b.domain = a.prepareDomain(b.domain) : (b.ga = !1,
        b.branding = !0,
        b.mobile = !0,
        b.desktop = !0,
        delete b.greeting,
    ...
    a.prepareDomain = function(a) {
        ...
        return "www." === b.substr(0, 4) && (b = b.substr(4)),
        b
    }
    ,
...
var WidgetSendButtonBase = function() {
    function a(a, b, c) {
        ...
        this.goState = function(a, b) {
            ...
            !d.animationControl.isRunAnimation()) {
                ...
                if (d.widgetState.canGoState(c, a)) {
                    switch (d.params.showHelloPopup = !1,
                    c) {
            ...
            !(e > 100))
                if (a.animationControl.isRunAnimation())
                    ...
                    case StateMashine.WIDGET_STATE_BUTTON_ACTION:
                        ...
                        c.runButtonAction(),
                        c.isExistActionState() ? d.widgetState.goState(StateMashine.WIDGET_STATE_BUTTON_ACTION) : d.widgetState.goState(StateMashine.WIDGET_STATE_ACTIVATOR);
                        break;
                    case StateMashine.WIDGET_STATE_SLIDER:
        ...
        EventManager.subscribe(EventManager.EVENT_MOUSE_OUT_MSG_BUTTON, this.onMouseOut),
        EventManager.subscribe(EventManager.EVENT_MOUSE_OVER_MSG_BUTTON, this.onMouseOver),
        ...
        EventManager.subscribe(EventManager.EVENT_CLOSE_HELLO_POPUP, this.onCloseHelloPopup),
        this.resize()
    }
  ...
  , StateMashine = function() {
    function a(b, c) {
        ...
        this.goState = function(a) {
            return !!d.canGoState(d.state, a) && (d.setState(a),
            !0)
        }
        ,
        ...
        this.isMobile ? this.baseState = a.WIDGET_STATE_ACTIVATOR : this.baseState = a.WIDGET_STATE_ACTIVATOR_WITH_CALL_TO_ACTION
    }
    return a.stateJumpRules = function(b, c) {
        void 0 === c && (c = !1);
        var d = {};
        return d[a.WIDGET_STATE_ACTIVATOR] = [],
        d[a.WIDGET_STATE_SLIDER] = [c ? a.WIDGET_STATE_ACTIVATOR : a.WIDGET_STATE_ACTIVATOR_WITH_CALL_TO_ACTION, a.WIDGET_STATE_BUTTON_ACTION],
        d[a.WIDGET_STATE_BUTTON_ACTION] = [c ? a.WIDGET_STATE_ACTIVATOR : a.WIDGET_STATE_ACTIVATOR_WITH_CALL_TO_ACTION],
        c || (d[a.WIDGET_STATE_HELLO] = [a.WIDGET_STATE_ACTIVATOR_WITH_CALL_TO_ACTION, a.WIDGET_STATE_BUTTON_ACTION],
        ...
        c || d[a.WIDGET_STATE_ACTIVATOR_WITH_CALL_TO_ACTION].push(a.WIDGET_STATE_BUTTON_ACTION)) : (d[a.WIDGET_STATE_ACTIVATOR].push(a.WIDGET_STATE_SLIDER),
        c || (d[a.WIDGET_STATE_HELLO].push(a.WIDGET_STATE_SLIDER),
        d[a.WIDGET_STATE_ACTIVATOR_WITH_CALL_TO_ACTION].push(a.WIDGET_STATE_SLIDER))),
        d
    }
    ,
    a
...
StateMashine.WIDGET_STATE_ACTIVATOR_WITH_CALL_TO_ACTION = "widgetStateActivatorWithCallToAction",
...
var WidgetSendButtonContainer = function() {
        ...
        this.onPostMessage = function(a) {
            if (a.origin.replace(/^https?:\/\//, "") === "widget." + c.params.host)
                try {
                    ...
                    "wh-change-url" === b.name && c.onPostMessageClickButton(b, c.onPostMessageChangeUrl),
                    "wh-open-tab" === b.name && (c.onPostMessageClickButton(b),
                    c.onPostMessageOpenTab(b)),
    ...
    a.prototype.onPostMessageResize = function(a) {
        ...
        b && (b.style.width = a.width.toString() + "px",
    ...
    a.prototype.buildWidget = function() {
        ...
        if (this.options.shift_horizontal > 0 && (c.style[this.options.position] = this.options.shift_horizontal + "px"),
        this.options.shift_vertical > 0) {
            var d = c.getAttribute("style");
            null === d && (d = ""),
            c.setAttribute("style", d + " bottom: " + this.options.shift_vertical + "px !important;")
        }
        WidgetDOM.setClass(c, "wh-widget-" + this.options.position),
        this.container = c,
        this.params.isMobile && !WidgetDOM.isViewportExist() && WidgetDOM.addMeta("wh-viewport")
    }
    ,
    ...
    a.prototype.getWidgetUrl = function() {
        var b = 0;
        Cookie.check(a.cookieName) || (b = 1,
        Cookie.set(a.cookieName, "1", a.cookieExpire));
